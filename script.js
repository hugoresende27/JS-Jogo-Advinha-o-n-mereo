...
///////////////////////////////////tempo/////////////////////
var dias_e=document.getElementById("dias");
var horas_e=document.getElementById("horas");
var minutos_e=document.getElementById("minutos");
var segundos_e=document.getElementById("segundos");

var ano = '1 Jan 2022';  //variavel ano 1 Jan 2022, data do primeiro dia do ano novo

function contagem(){
    var ano_novo= new Date(ano);          //ano_novo recebe valor de ano
    var data= new Date();                 //criar o objeto data

    var total_segundos=new Date(ano_novo-data)/1000;        //calculo dos segundo q faltam ate ao fim do ano, ano_novo tem valor de data de fim de ano e data tem valor da data atual

    var dias= Math.floor(total_segundos/3600/24);           //calculo dias segundos a dividir por 3600segundos(1hora)//24 horas(1dia)      
    var horas=Math.floor(total_segundos/3600)%24;           //para calcular as horas, resto da divisao por 24

    var minutos=Math.floor(total_segundos/60)%60;           //para calcular os minutos

    var segundos=Math.floor(total_segundos)%60;             //para calcular os segundos
